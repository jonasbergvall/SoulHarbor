...
for deltagare in samarbete_data.index:
    dot += f"  {deltagare};\n"
...
for i in range(samarbete_data.shape[0]):
    for j in range(samarbete_data.shape[1]):
        if samarbete_data.iloc[i, j] == 1:
            dot += f"  {samarbete_data.index[i]} -> {samarbete_data.index[j]};\n"
...
for i in range(samarbete_data.shape[0]):
    for j in range(samarbete_data.shape[1]):
        if samarbete_data.iloc[i, j] == 1:
            st.markdown(f"    - {samarbete_data.index[j]}")
...
for i in range(samarbete_data.shape[0]):
    for j in range(samarbete_data.shape[1]):
        if samarbete_data.iloc[i, j] == 1 and samarbete_data.loc[samarbete_data.index[i], f"Samarbete{j+1}"] == 0:
